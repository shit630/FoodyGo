...
const OwnerDashboard = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#fff9f6] flex flex-col items-center">
          ...
          <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            <div className="flex flex-col items-center text-center">
              ...
              <button
                ...
                className="bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md cursor-pointer hover:bg-orange-600 transition-colors duration-200"
              >
                Get Staretd
              </button>
            </div>
      ...
      {myShopData && (
        <div className="w-full h-full flex flex-col items-center gap-6 px-4 sm:px-6">
          <h1 className="text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center">
            <FaUtensils className="text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4" />
            Wellcome to {myShopData?.name}
          </h1>

          <div className="w-full bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 max-w-3xl relative">
            <div
            ...
            <img
              ...
              alt={myShopData?.name}
              className="w-full sm:h-65 object-fill"
            />
